...
export function ThemeDrawer({ theme, onOpenChange, openIssuesCount = 0 }: Props) {
  ...
  const githubEditUrl = theme
    ? `https://github.com/brain-bbqs/website/tree/main/${theme.githubPath}`
    : "#";
  const githubIssuesUrl = theme
    ? `https://github.com/brain-bbqs/website/issues?q=is%3Aissue+label%3A${encodeURIComponent(theme.githubLabel)}`
    : "#";
