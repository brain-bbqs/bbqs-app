...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      create_grant: {
        Args: {
          _contact_pi_email?: string
          _fiscal_year?: number
          _grant_number: string
          _institution?: string
          _study_human?: boolean
          _title: string
        }
        Returns: Json
      }
      ...
      provenance_attach_recorder: { Args: { _table: string }; Returns: boolean }
      ...
      source_class_was_declared: { Args: never; Returns: boolean }
